...
// Fokus: Tampilan — warna aksen, ukuran teks, dark mode
// Header: Animated avatar border 3 lapis
...
export default function SettingsScreen() {
  ...
  return (
    ...
    >
      {/* ════════════════════════════════
          HERO — Avatar + nama + animated border
          ════════════════════════════════ */}
      <Animated.View style={[styles.hero, { opacity: fadeAnims[0] }]}>
        ...
        {/* Animated avatar border 3 lapis */}
        ...
        {/* Nama & email */}
        <Text style={[styles.heroName, { color: textCol }]}>
          {userProfile?.name || 'User'}
        </Text>
        <Text style={[styles.heroEmail, { color: subText }]}>
          {userProfile?.email || ''}
        </Text>

        {/* Accent color badge kecil */}
        <View style={[styles.heroBadge, { backgroundColor: accentColor + '22', borderColor: accentColor + '55' }]}>
          ...
          <Text style={[styles.heroBadgeTxt, { color: accentColor }]}>
            Tema Aktif
          </Text>
        </View>
      </Animated.View>
      ...
      <Animated.View style={{
        ...
        >
          ...
          <View style={[styles.colorPreviewBar, { backgroundColor: accentColor }]}>
            <Text style={styles.colorPreviewTxt}>
              Preview Warna Tema
            </Text>
          ...
          <View style={styles.textSizeRow}>
            {TEXT_SIZES.map(({ value, label, preview }) => {
              ...
              return (
                ...
                >
                  <Text style={[styles.textSizePreview, { fontSize: preview, color: isSelected ? accentColor : (isDarkMode ? '#f0f0f0' : '#333') }]}>
                    Aa
                  </Text>
                  <Text style={[styles.textSizeLabel, { color: isSelected ? accentColor : subText }]}>
                    {label}
                  </Text>
                  {isSelected && (
                    <View style={[styles.textSizeDot, { backgroundColor: accentColor }]} />
                  )}
                </TouchableOpacity>
              );
            })}
      ...
      <Animated.View style={{
        ...
        >
          ...
          <SettingRow
            icon="🗑️"
            label="Hapus Riwayat Pesanan"
            desc="Bersihkan semua riwayat lokal"
            accentColor={accentColor}
            isDarkMode={isDarkMode}
            right={
              <TouchableOpacity
                ...
                onPress={() => Alert.alert(
                  'Hapus Riwayat',
                  'Yakin ingin menghapus semua riwayat pesanan?',
                  [
...
const styles = StyleSheet.create({
  ...
  heroName:           { fontSize: 22, fontWeight: '900', marginTop: 16, marginBottom: 4, letterSpacing: 0.3 },
